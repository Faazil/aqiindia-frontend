...
export default function Delhi(){
  ...
  useEffect(()=>{
    ...
    axios.get(`${apiBase}/api/top-cities`).then(r=>{
      ...
      const city = (r.data || []).find(c => c.city.toLowerCase() === "delhi");
  ...
  return (
    <div className="container">
      <h1>AQI Today — Delhi</h1>
      <p>Live air quality (AQI) in Delhi. This page is updated regularly with the latest PM2.5 and PM10 readings.</p>
